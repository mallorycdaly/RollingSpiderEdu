...
% altitude from tested KF
plot(RSrun_states_estim(:,1),RSrun_states_estim(:,4),'LineWidth',3);
% altitude from simulated KF
plot(states_estimout.Z.Time,states_estimout.Z.Data,'y','LineWidth',2)
% altitude reference
plot(RSrun_pos_ref(:,1),RSrun_pos_ref(:,4),'g','LineWidth',2);
% legend and labels
legend('pressure measurements','sonar measurements','tested KF estimate','sim KF estimate','reference','Location','Best')
xlabel('Time (s)','Interpreter','latex')
